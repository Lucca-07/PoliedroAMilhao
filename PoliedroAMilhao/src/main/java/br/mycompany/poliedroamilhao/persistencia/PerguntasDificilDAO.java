...
public class PerguntasDificilDAO {
    ...
    public Perguntas buscarPerguntaDificil(int idMateria) throws Exception {
        Perguntas pergunta = null;

        StringBuilder consultasql = new StringBuilder("SELECT * FROM Perguntas WHERE Dificuldade LIKE 'Difícil'");
